...
export const PageNoFound = () => {
	return (
		<div className='bg-black grid grid-cols-1 pl-60'>
			<div className='container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12'>
				<div className='wf-ull lg:w-1/2'>
					...
					<div className='flex items-center mt-6 gap-x-3'>
						...
						<Link
							to='/'
							className='w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-[#2655FD] rounded-lg shrink-0 sm:w-auto hover:bg-[#7a460b]'>
							Pagina de inicio
						</Link>
					</div>
				</div>
